...
function OrderDetailsItem({
  ...
  return (
    <HStack py="2" justifyContent="space-between" {...props}>
      <Text fontSize="xs" _light={{ color: 'coolGray.800' }} _dark={{ color: 'coolGray.50' }}>
        {orderKey}
      </Text>
      <Text
        fontSize="xs"
  ...
  return (
    ...
    >
      ...
      <HStack pt="3" pb="2" justifyContent="space-between">
        ...
        <Text fontSize="sm" _light={{ color: 'coolGray.800' }} _dark={{ color: 'coolGray.50' }}>
          3340.00
        </Text>
      </HStack>
    </Box>
...
const SelectPaymentMethodScreen: React.FC<any> = ({ navigation }) => {
  return (
    <>
      <DashboardLayout title="Pagar" navigation={navigation}>
        ...
        >
          ...
          >
            <MainContent />
            <Button variant="solid" size="lg" mt="auto" mb="1" mx={{ base: '4', md: '0' }}>
              Continuar
            </Button>
          </Box>
        </KeyboardAwareScrollView>
...
export { SelectPaymentMethodScreen };
